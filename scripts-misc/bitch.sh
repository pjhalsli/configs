...
xdef="~/.config/termite/config"
TermFont="$(grep 'font' ~/.config/termite/config | awk '{print $2}' | cut -d ":" -f2 | cut -d ":" -f1)"
...
$f7              cMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMNk;.                  Font  » $GtkFont 
